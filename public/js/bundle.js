...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"alart.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showModal = exports.showAlert = exports.hideAlert = exports.autoMultiply = void 0;
...
var autoMultiply = function autoMultiply(btnprice, btnquantity) {
  btnprice.forEach(function (el) {
    el.addEventListener('input', function () {
      var quantity = this.parentElement.querySelector('#quantity').value;
      var price = this.value;
      var sum = quantity * price * 1;
  ...
  btnquantity.forEach(function (el) {
    el.addEventListener('input', function () {
      var price = this.parentElement.querySelector('#price').value;
...
exports.updatePassword = exports.updatePassChangeWindow = exports.updateMe = exports.logout = exports.login = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alart = require("./alart");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alart.showAlert)('success', 'Log in successfull!....');
            window.setTimeout(function () {
              location.reload();
            }, 1500);
          }
        ...
        case 7:
          ...
          (0, _alart.showAlert)('error', _context.t0.response.data.message);
        case 10:
        case "end":
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') (0, _alart.showAlert)('success', 'Logged out successful');
          window.setTimeout(function () {
            location.assign('/');
          }, 1500);
          _context2.next = 12;
        ...
        case 8:
          ...
          (0, _alart.showAlert)('error', 'Your are not logged in! Please try again...');
        case 12:
        case "end":
...
var updateMe = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var email, name, id, res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          try {
            email = document.querySelector('.input_user_email').value;
            name = document.querySelector('.input_user_name').value;
            id = document.querySelector('.input_user_name').dataset.userid;
            console.log(email, name, id);
            res = (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:5000/api/v1/user/updateUser/".concat(id),
              data: {
                name: name,
                email: email
              }
            ...
            if (res.data.status === 'success') {
              (0, _alart.showAlert)('success', 'successfully updated!');
              window.setTimeout(function () {
                location.assign('/');
              }, 2000);
            }
...
var updatePassChangeWindow = function updatePassChangeWindow() {
  var forgot_passwindow = document.querySelector('.forgot_passwindow');
  var btnforgotpasslinks = document.querySelector('.links_forgot_password');
  (0, _alart.showModal)();
  ...
  confirmModalButton.addEventListener('click', function () {
    ...
    if (document.querySelector('.form_container')) document.querySelector('.form_container').style.display = 'none';

    // const btnupdatePassword = document.querySelector('.update_password_btn');
  });
};
exports.updatePassChangeWindow = updatePassChangeWindow;
var updatePassword = function updatePassword() {
  try {
    var passwordCurrent = document.querySelector('.input_user_pssword_old').value;
    var password = document.querySelector('.input_user_pssword_new').value;
    var id = document.querySelector('.input_user_name').dataset.userid;
    var res = (0, _axios.default)({
      url: "http://127.0.0.1:5000/api/v1/user/updatePass/".concat(id),
      method: 'POST',
      data: {
        id: id,
        password: password,
    ...
    if (res.data.status === 'success') {
      (0, _alart.showAlert)('success', 'password successfully updated!');
      window.setTimeout(function () {
        location.assign('/');
      }, 2000);
    }
...
},{"axios":"../../node_modules/axios/index.js","./alart":"alart.js"}],"product.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.searchproduct = exports.renderSearchproduct = exports.renderPrint = exports.renderEditPage = exports.editProduct = exports.deleteproduct = exports.addProductToDB = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alart = require("./alart");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var addProductToDB = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(types) {
    var name, typeOf, id, method, url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          name = document.querySelector('#productname').value;
          typeOf = [document.querySelector('#type').value];
          id = types === 'update' ? document.querySelector('.productId').dataset.productid : '';
          method = types === 'new' ? 'POST' : 'PATCH';
          url = types === 'new' ? 'http://127.0.0.1:5000/api/v1/product/createOne' : "http://127.0.0.1:5000/api/v1/product/updateOne/".concat(id);
          _context.next = 8;
          return (0, _axios.default)({
            method: method,
            url: url,
        ...
        case 8:
          ...
          if (res.data.status === 'success') {
            window.setTimeout(function () {
              (0, _alart.showAlert)('success', "".concat(types, " product added successfully..."));
  ...
  return function addProductToDB(_x) {
    return _ref.apply(this, arguments);
  };
}();
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return (0, _axios.default)({
            url: "http://127.0.0.1:5000/api/v1/product/getone/".concat(id),
            method: 'GET'
          });
        case 3:
          res = _context2.sent;
        ...
        case 6:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alart.showAlert)('success', "Going for edit Product");
            window.setTimeout(function () {
        ...
        case 11:
          _context2.prev = 11;
          _context2.t0 = _context2["catch"](0);
          (0, _alart.showAlert)('error', _context2.t0.response.data.message);
        case 14:
        case "end":
          return _context2.stop();
      }
...
var searchproduct = /*#__PURE__*/function () {
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            localStorage.clear();
            localStorage.setItem('productData', JSON.stringify(res.data.data));
            (0, _alart.showAlert)('success', 'Searching for product');
            window.setTimeout(function () {
        ...
        case 7:
          ...
          (0, _alart.showAlert)('error', _context3.t0.response.data.message);
        case 10:
        case "end":
          return _context3.stop();
      }
  ...
  return function searchproduct(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          confirmModalButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
            var res;
            return _regeneratorRuntime().wrap(function _callee4$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  return (0, _axios.default)({
                    method: 'DELETE',
                    url: "http://127.0.0.1:5000/api/v1/product/deleteOne/".concat(id)
                  });
                case 4:
                  res = _context4.sent;
                  (0, _alart.showAlert)('success', 'Data deleted successfully');
                  window.setTimeout(function () {
                    location.assign('/allproduct');
                  });
                  _context4.next = 12;
                ...
                case 9:
                  ...
                  (0, _alart.showAlert)('error', _context4.t0.response.data.message);
                case 12:
                case "end":
...
var renderSearchproduct = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var productData, product, to, from, reqData, res;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          (0, _alart.showAlert)('error', 'product not found! Going back to provious page');
          return _context6.abrupt("return", window.setTimeout(function () {
            location.assign('/allproduct');
          }, 1500));
        case 5:
        ...
        case 12:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alart.showAlert)('success', 'Print data in seconds...');
            window.setTimeout(function () {
  ...
  return function renderSearchproduct() {
    return _ref6.apply(this, arguments);
  };
}();
exports.renderSearchproduct = renderSearchproduct;
var renderPrint = function renderPrint(printsellFrom) {
  var productData = JSON.parse(localStorage.getItem('productDatas'));
  var product = JSON.parse(localStorage.getItem('reqData'));
  var markup = "\n    <div class=\"container-fluid\">\n      <div class=\"row align-content-center print--title\">\n        <div class=\"col-12 d-flex justify-content-center\">\n          <h2 class=\"h2 mt-4\">Ovi Shop</h2>\n        </div>\n      </div>\n      <div class=\"row align-content-center print--address\">\n        <h4 class=\"col-12 d-flex justify-content-center h6\">\n          Modina Market(Third and Forth Floor), Muradpur, Chittagong.\n        </h4>\n      </div>\n      <div class=\"row align-content-center print--branch\">\n        <p class=\"col-12 d-flex justify-content-center h5\">Presenting summery of ".concat(product.product, "</p>\n      </div>\n      <div class=\"row align-content-center print--header\">\n        <h3 class=\"col-12 d-flex justify-content-center h3 print--type\">\n          Party Payment\n        </h3>\n      </div>\n      <div class=\"row mt-2 align-content-center print--voucher\">\n        <div class=\"col d-flex justify-content-around \">\n          <p>\n            From:<span class=\"v--date__from\"> ").concat(product.from, " </span>To: \n            <span class=\"v--date__to\">").concat(product.to, " </span>\n          </p>\n        </div>\n      </div>\n      \n      <div class=\"row align-content-center print--content--header\">\n        <div class=\"col-1 d-flex justify-content-start\">\n          <label for=\"Serial--no\">SL No</label>\n        </div>\n        <div class=\"col-2 d-flex justify-content-start\">\n          <label for=\"ledgerName\">Date</label>\n        </div>\n        <div class=\"col-2 d-flex justify-content-start\">\n          <label for=\"quantity\">Quantity</label>\n        </div>\n        <div class=\"col-2 d-flex justify-content-start\">\n          <label for=\"rate\">Rate</label>\n        </div>\n        <div class=\"col-2 d-flex justify-content-start\">\n          <label for=\"purchase\">Purchase Tk.</label>\n        </div>\n        <div class=\"col d-flex justify-content-start\">\n          <label for=\"sell\">Sell Tk.</label>\n        </div>\n      </div>\n\n\n      ").concat(function () {
    var sNo = 1;
    return productData.map(function (el) {
      return el.purchases ? el.purchases.map(function (cEl) {
        var currentSNo = sNo;
        sNo += 1;
        return "<div class=\"row align-content-center print--content--body\">\n          <div class=\"col-1 d-flex justify-content-start\">\n            <label class=\"Serial--no\">".concat(currentSNo, "</label>\n          </div>\n          <div class=\"col-2 d-flex justify-content-start\">\n            <label class=\"date\">").concat(el.date.split('T')[0], "</label>\n          </div>\n          <div class=\"col-2 d-flex justify-content-start\">\n            <label class=\"purchase-quantity\">").concat(cEl.quantity.toFixed(2), "</label>\n          </div>\n          <div class=\"col-2 d-flex justify-content-start\">\n            <label class=\"purchase-rate\">").concat(cEl.rate.toFixed(2), "</label>\n          </div>\n          <div class=\"col-2 d-flex justify-content-start\">\n            <label class=\"purchase-amount\">").concat(cEl.totalAmount.toFixed(2), "</label>\n          </div>\n          <div class=\"col d-flex justify-content-start\">\n            <label class=\"sell-amount\">0</label>\n          </div>\n        </div>");
      }) : el.sells.map(function (cEl) {
        var currentSNo = sNo;
        sNo += 1;
        return "<div class=\"row align-content-center print--content--body\">\n          <div class=\"col-1 d-flex justify-content-start\">\n            <label class=\"Serial--no\">".concat(currentSNo, "</label>\n          </div>\n          <div class=\"col-2 d-flex justify-content-start\">\n            <label class=\"date\">").concat(el.date.split('T')[0], "</label>\n          </div>\n          <div class=\"col-2 d-flex justify-content-start\">\n            <label class=\"sell-quantity\">").concat(cEl.quantity.toFixed(2), "</label>\n          </div>\n          <div class=\"col-2 d-flex justify-content-start\">\n            <label class=\"sell-rate\">").concat(cEl.rate.toFixed(2), "</label>\n          </div>\n          <div class=\"col-2 d-flex justify-content-start\">\n            <label class=\"purchase-amount\">0</label>\n          </div>\n          <div class=\"col d-flex justify-content-start\">\n            <label class=\"sell-amount\">").concat(cEl.totalAmount.toFixed(2), "</label>\n          </div>\n        </div>");
      });
    }).flat().join('');
  }(), "\n               \n      <div class=\"row align-content-center print--content--total\">\n        <div class=\"col-3 d-flex justify-content-end\">\n          <label>Total Purchase Quantity = </label>\n        </div>\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label class=\"total-purchase-quantity\">\n          ").concat(productData.map(function (el) {
    return el.purchases ? el.purchases.reduce(function (acc, el) {
    ...
    return el.purchases ? el.purchases.reduce(function (acc, el) {
      return acc + el.totalAmount * 1;
    }, 0) : 0;
  }).reduce(function (acc, el) {
    return acc + el;
  }, 0).toFixed(2), "\n            </label>\n        </div>\n      </div>\n\n      <div class=\"row align-content-center print--content--total\">\n        <div class=\"col-3 d-flex justify-content-end\">\n          <label>Total Sell Quantity = </label>\n        </div>\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label class=\"total-sell-quantity\">\n          ").concat(productData.map(function (el) {
    return el.sells ? el.sells.reduce(function (acc, el) {
      return acc + el.quantity * 1;
    }, 0) : 0;
  }).reduce(function (acc, el) {
    return acc + el;
...
},{"axios":"../../node_modules/axios/index.js","./alart":"alart.js"}],"purchase.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendSumAmount = exports.searchedpurchaseToView = exports.saveNewpurchaseOrUpdate = exports.renderViewPage = exports.renderPrint = exports.removepurchaseproductElement = exports.printpurchase = exports.deletepurchase = exports.deleteRenderViewPageEl = exports.addpurchaseproductEement = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alart = require("./alart");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var addpurchaseproductEement = function addpurchaseproductEement() {
  var btnAdd = document.querySelector('#add--more__product');
  ...
  if (btnAdd) btnAdd.addEventListener('click', function (e) {
    ...
    (0, _axios.default)({
      ...
      var products = res.data.data.data;
      var markup = "\n                <div class=\"purchase--content purchase--content__body\">\n                  <label for=\"\" class=\"mb-0 m-3 form-label text-wrap\">1</label>\n                  <select\n                    style=\"width: 25%\"\n                    class=\"form-select form-control m-3\"\n                    name=\"productName\"\n                    id=\"productName\"\n                    required\n                  >\n                    <option selected>Select a product name</option>\n                    ".concat(products.map(function (el) {
        return "<option value=".concat(el._id, ">\n                      ").concat(el.name, "\n                    </option>");
      }), "\n                  </select>\n                  <input\n                    style=\"width: 23%\"\n                    type=\"text\"\n                    id=\"quantity\"\n                    class=\"form-control m-3\"\n                    required\n                    placeholder=\"product quantity\"\n                  />\n                  <input\n                    style=\"width: 23%\"\n                    type=\"text\"\n                    id=\"price\"\n                    class=\"form-control m-3\"\n                    required\n                    placeholder=\"product price\"\n                  />\n                  <input\n                    style=\"width: 23%\"\n                    type=\"number\"\n                    id=\"amount\"\n                    class=\"form-control m-3\"\n                    required\n                    placeholder=\"Amount\"\n                  />\n                </div>\n        ");
      parentEl.insertAdjacentHTML('beforeend', markup);
      var btnprice = document.querySelectorAll('#price');
      var btnquantity = document.querySelectorAll('#quantity');
      (0, _alart.autoMultiply)(btnprice, btnquantity);
    }).catch(function (err) {
      return (0, _alart.showAlert)('error', err.response.data.message);
    });
  });
};

//   3) Removeing last purchase items
exports.addpurchaseproductEement = addpurchaseproductEement;
var removepurchaseproductElement = function removepurchaseproductElement() {
  var btnRemove = document.querySelector('#remove--last__product');
  var purchaseBodyEl = document.querySelector('.data');
  if (btnRemove) btnRemove.addEventListener('click', function (e) {
    e.preventDefault();
...
exports.removepurchaseproductElement = removepurchaseproductElement;
var searchedpurchaseToView = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(purchaseId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:5000/api/v1/purchase/getOne/".concat(purchaseId)
          });
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            ...
            (0, _alart.showAlert)('success', 'we are going in seconds...');
            window.setTimeout(function () {
  ...
  return function searchedpurchaseToView(_x) {
    return _ref.apply(this, arguments);
  };
}();

//   5) Delete purchase
exports.searchedpurchaseToView = searchedpurchaseToView;
var deletepurchase = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(purchaseId) {
    var cancelModalButton, confirmModalButton;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  return (0, _axios.default)({
                    method: 'DELETE',
                    url: "http://127.0.0.1:5000/api/v1/purchase/deleteOne/".concat(purchaseId)
                  });
                case 4:
                  res = _context2.sent;
                  localStorage.clear();
                  (0, _alart.showAlert)('success', 'purchase Deleted Successfully');
  ...
  return function deletepurchase(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
var printpurchase = /*#__PURE__*/function () {
  ...
  return function printpurchase(_x3) {
    return _ref4.apply(this, arguments);
  };
}();
...
var deleteRenderViewPageEl = function deleteRenderViewPageEl() {
  var btndeletePreviousItem = document.querySelectorAll('#view--purchase__delete');
...
var saveNewpurchaseOrUpdate = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(type) {
    var btnSave;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          btnSave = document.querySelector('#add--purchase__submit');
          if (btnSave) btnSave.addEventListener('click', /*#__PURE__*/function () {
            var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
              var date, productName, quantity, price, amount, id, purchases, url, method, i, data, res;
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  case 0:
                    e.preventDefault();
                    ...
                    id = type === 'update' ? document.querySelector('.purchase--header').dataset.purchaseid : null;
                    purchases = [];
                    url = type === 'new' ? 'http://127.0.0.1:5000/api/v1/purchase/createOne' : type === 'update' ? "http://127.0.0.1:5000/api/v1/purchase/updateOne/".concat(id) : null;
                    ...
                    for (i = 0; i < productName.length; i++) {
                      purchases.push({
                        ...
                        name: productName[i].nodeName === 'LABEL' ? productName[i].dataset.productid : productName[i].value,
                  ...
                  case 16:
                    res = _context5.sent;
                    if (res.data.status === 'success') {
                      (0, _alart.showAlert)('success', "purchase ".concat(type === 'new' ? 'Saved' : 'updated', " successfully"));
                      window.setTimeout(function () {
                  ...
                  case 20:
                    ...
                    (0, _alart.showAlert)('error', _context5.t0.response.data.message);
                    // console.log(err);
                  case 23:
                  case "end":
                    return _context5.stop();
  ...
  return function saveNewpurchaseOrUpdate(_x4) {
    return _ref5.apply(this, arguments);
  };
}();

//  10) Print purchase
exports.saveNewpurchaseOrUpdate = saveNewpurchaseOrUpdate;
var renderPrint = function renderPrint(printpurchaseFrom) {
  var purchaseData = JSON.parse(localStorage.getItem('purchaseData'));
  var markup = "\n    <div class=\"row align-content-center print--title\">\n      <div class=\"col-12 d-flex justify-content-center\">\n          <h2 class=\"h2 mt-4\">Ovi Shop</h2>\n        </div>\n      </div>\n      <div class=\"row align-content-center print--address\">\n        <h4 class=\"col-12 d-flex justify-content-center h6\">\n          Modina Market(Third and Forth Floor), Muradpur, Chittagong.\n        </h4>\n      </div>\n      <div class=\"row align-content-center print--header\">\n        <h3 class=\"col-12 d-flex justify-content-center h3 print--type\">\n          purchase Slip\n        </h3>\n      </div>\n      <div class=\"row mt-2 align-content-center print--voucher\">\n        <div class=\"col-2 d-flex justify-content-around\">\n          <p>Voucher No:</p>\n        </div>\n        <div class=\"col-4 d-flex justify-content-around\">\n          <p class=\"v--no\">".concat(purchaseData.data._id, "</p>\n        </div>\n        <div class=\"col-3 d-flex justify-content-around\"></div>\n        <div class=\"col-3 d-flex justify-content-around\">\n          <p>Date:<span class=\"v--date\">").concat(purchaseData.data.date.split('T')[0], "</span></p>\n        </div>\n      </div>\n      <div class=\"row align-content-center print--content--header\">\n        <div class=\"col-1 d-flex justify-content-start\">\n          <label for=\"Serial--no\">SL No</label>\n        </div>\n        <div class=\"col-2 d-flex justify-content-start\">\n          <label for=\"productName\">products</label>\n        </div>\n        <div class=\"col-4 d-flex justify-content-start\">\n          <label for=\"purpose\">Quantity</label>\n        </div>\n        <div class=\"col-2 d-flex justify-content-start\">\n          <label for=\"price\">Price</label>\n        </div>\n        <div class=\"col d-flex justify-content-start\">\n          <label for=\"amount\">Amount</label>\n        </div>\n      </div>\n      ").concat(purchaseData.data.purchases.map(function (el, i) {
    return "\n          <div class=\"row align-content-center print--content--body\">\n            <div class=\"col-1 d-flex justify-content-start\">\n              <label class=\"Serial--no\">".concat(i + 1, "</label>\n            </div>\n            <div class=\"col-2 d-flex justify-content-start\">\n              <label class=\"productName\">").concat(el.name.name, "</label>\n            </div>\n            <div class=\"col-4 d-flex justify-content-start\">\n              <label class=\"quantity\">").concat(el.quantity, "</label>\n            </div>\n            <div class=\"col-2 d-flex justify-content-start\">\n              <label class=\"price\">").concat(el.rate.toFixed(2), "</label>\n            </div>\n            <div class=\"col d-flex justify-content-start\">\n              <label class=\"amount\">").concat(el.totalAmount.toFixed(2), "</label>\n            </div>\n          </div>");
  }).join(''), "\n      <div class=\"row align-content-center print--content--total\">\n        <!-- <div class=\"col-1 d-flex justify-content-start\"><label class=\"Serial--no\">1</label></div> -->\n        <div class=\"col-1 d-flex justify-content-start\"></div>\n        <div class=\"col-2 d-flex justify-content-start\"></div>\n        <div class=\"col-4 d-flex justify-content-start\">\n          <label></label>\n        </div>\n        <div class=\"col-2 d-flex justify-content-start\">\n          <label class=\"total\">Total</label>\n        </div>\n        <div class=\"col d-flex justify-content-start\">\n          <label class=\"total-amount\">").concat(purchaseData.data.summeryAmount.toFixed(2), "</label>\n        </div>\n      </div>\n\n      <div class=\"row mt-5 align-content-center print--footer\">\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label> &nbsp;&nbsp;&nbsp;&nbsp;Prepared By&nbsp;&nbsp;&nbsp;&nbsp; </label>\n        </div>\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label>&nbsp;&nbsp;&nbsp;&nbsp;Checked By&nbsp;&nbsp;&nbsp;&nbsp;</label>\n        </div>\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label>&nbsp;&nbsp;&nbsp;&nbsp;Approved By&nbsp;&nbsp;&nbsp;&nbsp;</label>\n        </div>\n      </div>\n    </div>\n  ");
  printpurchaseFrom.insertAdjacentHTML('afterbegin', markup);
};
exports.renderPrint = renderPrint;
},{"axios":"../../node_modules/axios/index.js","./alart":"alart.js"}],"sell.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendSumAmount = exports.searchedsellToView = exports.saveNewsellOrUpdate = exports.renderViewPage = exports.renderPrint = exports.removesellproductElement = exports.printsell = exports.deletesell = exports.deleteRenderViewPageEl = exports.addsellproductEement = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alart = require("./alart");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
exports.sendSumAmount = sendSumAmount;
var addsellproductEement = function addsellproductEement() {
  var btnAdd = document.querySelector('#add--more__product');
  var parentEl = document.querySelector('.data');
  if (btnAdd) btnAdd.addEventListener('click', function (e) {
    e.preventDefault();
...
exports.addsellproductEement = addsellproductEement;
var removesellproductElement = function removesellproductElement() {
  var btnRemove = document.querySelector('#remove--last__product');
  var sellBodyEl = document.querySelector('.data');
  if (btnRemove) btnRemove.addEventListener('click', function (e) {
    e.preventDefault();
...
exports.removesellproductElement = removesellproductElement;
var searchedsellToView = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(sellId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:5000/api/v1/sell/getOne/".concat(sellId)
          });
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
  ...
  return function searchedsellToView(_x) {
    return _ref.apply(this, arguments);
  };
}();

//   5) Delete sell
exports.searchedsellToView = searchedsellToView;
var deletesell = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(sellId) {
    var cancelModalButton, confirmModalButton;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  return (0, _axios.default)({
                    method: 'DELETE',
                    url: "http://127.0.0.1:5000/api/v1/sell/deleteOne/".concat(sellId)
                  });
                case 4:
                  res = _context2.sent;
                  localStorage.clear();
                  (0, _alart.showAlert)('success', 'sell Deleted Successfully');
                  location.reload(true);
                  _context2.next = 13;
                  break;
                case 10:
  ...
  return function deletesell(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
var printsell = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(sellId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
  ...
  return function printsell(_x3) {
    return _ref4.apply(this, arguments);
  };
}();

//   7) Render View sell Page from All sell Page
exports.printsell = printsell;
var renderViewPage = function renderViewPage() {
  var viewsellForm = document.querySelector('.form__sell--view');
  var sellData = JSON.parse(localStorage.getItem('sellData'));
  var sells = sellData.data.sells;
  var markup = "\n          <div class=\"sell--header\" data-sellid=\"".concat(sellData.data._id, "\">\n              <div class=\"sell--content\">\n                <label for=\"date\" class=\"mb-0 m-3 form-label text-wrap\"\n                  >From:</label\n                >\n                <input type=\"date\" value=\"").concat(sellData.data.date.split('T')[0], "\" id=\"date\" class=\"form-control m-3\" />\n              </div>\n            </div>\n            <div class=\"sell--body\">\n              <div class=\"sell--content sell--content__header\">\n                <label class=\"mb-0 m-3 form-label text-wrap\">SL No*</label>\n                <label class=\"mb-0 m-3 form-label text-wrap\"\n                  >product Name*</label\n                >\n                <label class=\"mb-0 m-3 form-label text-wrap\">Quantity*</label>\n                <label class=\"mb-0 m-3 form-label text-wrap\">Price*</label>\n                <label class=\"mb-0 m-3 form-label text-wrap\">Amount*</label>\n              </div>\n              <div class=\"data\">\n                ").concat(sells.map(function (el, i) {
...
exports.renderViewPage = renderViewPage;
var deleteRenderViewPageEl = function deleteRenderViewPageEl() {
  var btndeletePreviousItem = document.querySelectorAll('#view--sell__delete');
  btndeletePreviousItem.forEach(function (el) {
    return el.addEventListener('click', function (e) {
      e.preventDefault();
      e.target.parentElement.remove();
...
//  9) Save and Update data to Database using Axios request
exports.deleteRenderViewPageEl = deleteRenderViewPageEl;
var saveNewsellOrUpdate = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(type) {
    var btnSave;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          btnSave = document.querySelector('#add--sell__submit');
          if (btnSave) btnSave.addEventListener('click', /*#__PURE__*/function () {
            var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
              var date, productName, quantity, price, amount, id, sells, url, method, i, data, res;
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  case 0:
                    e.preventDefault();
                    // dom element storing
                    date = document.querySelector('#date').value ? document.querySelector('#date').value : new Date(Date.now());
                    productName = document.querySelectorAll('#productName');
                    quantity = document.querySelectorAll('#quantity');
                    price = document.querySelectorAll('#price');
                    amount = document.querySelectorAll('#amount');
                    id = type === 'update' ? document.querySelector('.sell--header').dataset.sellid : null;
                    sells = [];
                    url = type === 'new' ? 'http://127.0.0.1:5000/api/v1/sell/createOne' : type === 'update' ? "http://127.0.0.1:5000/api/v1/sell/updateOne/".concat(id) : null;
                    method = type === 'new' ? 'POST' : 'PATCH'; // console.log(method);
                    //// Get a subtotal
                    sendSumAmount();
                  ...
                  case 16:
                    res = _context5.sent;
                    if (res.data.status === 'success') {
                      (0, _alart.showAlert)('success', "sell ".concat(type === 'new' ? 'Saved' : 'updated', " successfully"));
                      window.setTimeout(function () {
  ...
  return function saveNewsellOrUpdate(_x4) {
    return _ref5.apply(this, arguments);
  };
}();

//  10) Print sell
exports.saveNewsellOrUpdate = saveNewsellOrUpdate;
var renderPrint = function renderPrint(printsellFrom) {
  var sellData = JSON.parse(localStorage.getItem('sellData'));
  var markup = "\n    <div class=\"row align-content-center print--title\">\n      <div class=\"col-12 d-flex justify-content-center\">\n          <h2 class=\"h2 mt-4\">Ovi Shop</h2>\n        </div>\n      </div>\n      <div class=\"row align-content-center print--address\">\n        <h4 class=\"col-12 d-flex justify-content-center h6\">\n          Modina Market(Third and Forth Floor), Muradpur, Chittagong.\n        </h4>\n      </div>\n      <div class=\"row align-content-center print--header\">\n        <h3 class=\"col-12 d-flex justify-content-center h3 print--type\">\n          sell Slip\n        </h3>\n      </div>\n      <div class=\"row mt-2 align-content-center print--voucher\">\n        <div class=\"col-2 d-flex justify-content-around\">\n          <p>Voucher No:</p>\n        </div>\n        <div class=\"col-4 d-flex justify-content-around\">\n          <p class=\"v--no\">".concat(sellData.data._id, "</p>\n        </div>\n        <div class=\"col-3 d-flex justify-content-around\"></div>\n        <div class=\"col-3 d-flex justify-content-around\">\n          <p>Date:<span class=\"v--date\">").concat(sellData.data.date.split('T')[0], "</span></p>\n        </div>\n      </div>\n      <div class=\"row align-content-center print--content--header\">\n        <div class=\"col-1 d-flex justify-content-start\">\n          <label for=\"Serial--no\">SL No</label>\n        </div>\n        <div class=\"col-2 d-flex justify-content-start\">\n          <label for=\"productName\">products</label>\n        </div>\n        <div class=\"col-4 d-flex justify-content-start\">\n          <label for=\"purpose\">Quantity</label>\n        </div>\n        <div class=\"col-2 d-flex justify-content-start\">\n          <label for=\"price\">Price</label>\n        </div>\n        <div class=\"col d-flex justify-content-start\">\n          <label for=\"amount\">Amount</label>\n        </div>\n      </div>\n      ").concat(sellData.data.sells.map(function (el, i) {
    return "\n          <div class=\"row align-content-center print--content--body\">\n            <div class=\"col-1 d-flex justify-content-start\">\n              <label class=\"Serial--no\">".concat(i + 1, "</label>\n            </div>\n            <div class=\"col-2 d-flex justify-content-start\">\n              <label class=\"productName\">").concat(el.name.name, "</label>\n            </div>\n            <div class=\"col-4 d-flex justify-content-start\">\n              <label class=\"quantity\">").concat(el.quantity, "</label>\n            </div>\n            <div class=\"col-2 d-flex justify-content-start\">\n              <label class=\"price\">").concat(el.rate.toFixed(2), "</label>\n            </div>\n            <div class=\"col d-flex justify-content-start\">\n              <label class=\"amount\">").concat(el.totalAmount.toFixed(2), "</label>\n            </div>\n          </div>");
  }).join(''), "\n      <div class=\"row align-content-center print--content--total\">\n        <!-- <div class=\"col-1 d-flex justify-content-start\"><label class=\"Serial--no\">1</label></div> -->\n        <div class=\"col-1 d-flex justify-content-start\"></div>\n        <div class=\"col-2 d-flex justify-content-start\"></div>\n        <div class=\"col-4 d-flex justify-content-start\">\n          <label></label>\n        </div>\n        <div class=\"col-2 d-flex justify-content-start\">\n          <label class=\"total\">Total</label>\n        </div>\n        <div class=\"col d-flex justify-content-start\">\n          <label class=\"total-amount\">").concat(sellData.data.summeryAmount.toFixed(2), "</label>\n        </div>\n      </div>\n\n      <div class=\"row mt-5 align-content-center print--footer\">\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label> &nbsp;&nbsp;&nbsp;&nbsp;Prepared By&nbsp;&nbsp;&nbsp;&nbsp; </label>\n        </div>\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label>&nbsp;&nbsp;&nbsp;&nbsp;Checked By&nbsp;&nbsp;&nbsp;&nbsp;</label>\n        </div>\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label>&nbsp;&nbsp;&nbsp;&nbsp;Approved By&nbsp;&nbsp;&nbsp;&nbsp;</label>\n        </div>\n      </div>\n    </div>\n  ");
  printsellFrom.insertAdjacentHTML('afterbegin', markup);
};
exports.renderPrint = renderPrint;
},{"axios":"../../node_modules/axios/index.js","./alart":"alart.js"}],"typeOfProduct.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderEditPage = exports.edittypeOfProduct = exports.deletetypeOf = exports.addtypeOfProductToDB = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alart = require("./alart");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var addtypeOfProductToDB = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(types) {
    var name, id, method, url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          name = document.querySelector('#typeOfname').value;
          id = types === 'update' ? document.querySelector('.typeofid').dataset.typeofid : '';
          console.log(id);
          method = types === 'new' ? 'POST' : 'PATCH';
          url = types === 'new' ? 'http://127.0.0.1:5000/api/v1/typeOf/createOne' : "http://127.0.0.1:5000/api/v1/typeOf/updateOne/".concat(id);
          _context.next = 8;
          return (0, _axios.default)({
            method: method,
            url: url,
        ...
        case 8:
          ...
          if (res.data.status === 'success') {
            window.setTimeout(function () {
              (0, _alart.showAlert)('success', "".concat(types, " Type of product added successfully..."));
  ...
  return function addtypeOfProductToDB(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.addtypeOfProductToDB = addtypeOfProductToDB;
var edittypeOfProduct = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 4;
          return (0, _axios.default)({
            url: "http://127.0.0.1:5000/api/v1/typeOf/getone/".concat(id),
            method: 'GET'
          });
        case 4:
          res = _context2.sent;
          if (res.data.status === 'success') {
            ...
            (0, _alart.showAlert)('success', "Going for edit typeOf");
            window.setTimeout(function () {
  ...
  return function edittypeOfProduct(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
exports.edittypeOfProduct = edittypeOfProduct;
var renderEditPage = function renderEditPage(edittypeOfForm) {
  var typeOfProdutData = JSON.parse(localStorage.getItem('typeOfProductData'));
  var markup = "\n         <form\n            action=\"\"\n            class=\"form form__edit--typeOf form-group m-3 px-3 mt-5 b-2 border border-danger\"\n          >\n            <h2 class=\"text-center form-text\">\n              Updating product type *: you must need another Name*.\n            </h2>\n            <div class=\"typeOf--info\">\n              <label for=\"typeOfname\" data-typeOfid=\"".concat(typeOfProdutData.data._id, "\" class=\"mb-0 m-1 form-label typeOfId text-wrap\"\n                >Name of typeOf*:</label\n              >\n              <input type=\"text\" value=\"").concat(typeOfProdutData.data.name, "\" required id=\"typeOfname\" class=\"form-control m-1\" />\n            <button class=\"m-3 btn btn-update btn-info\">Update</button>\n          </form> \n  ");
  edittypeOfForm.insertAdjacentHTML('afterbegin', markup);
};
exports.renderEditPage = renderEditPage;
var deletetypeOf = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          // for confirm deleting
          confirmModalButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
            var res;
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  return (0, _axios.default)({
                    method: 'DELETE',
                    url: "http://127.0.0.1:5000/api/v1/typeOf/deleteOne/".concat(id)
                  });
                case 4:
                  res = _context3.sent;
                  (0, _alart.showAlert)('success', 'Data deleted successfully');
  ...
  return function deletetypeOf(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
exports.deletetypeOf = deletetypeOf;
},{"axios":"../../node_modules/axios/index.js","./alart":"alart.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
var sell = _interopRequireWildcard(require("./sell"));
var typeOfProduct = _interopRequireWildcard(require("./typeOfProduct"));
var _alart = require("./alart");
...
var loginForm = document.querySelector('.user_card_login');
var btnLogout = document.querySelector('.nav__el--logout');
var formUpdateMe = document.querySelector('.update-user-settings');

// Purchase form
var formAddPurchase = document.querySelector('.form--el__addpurchase');
var formSearchPurchase = document.querySelector('.form--search__purchase');
var formEditPurchase = document.querySelector('.form--el__editpurchase');
var formPrintPurchase = document.querySelector('.form--purchase__print');

// Sell form
var formAddSell = document.querySelector('.form--el__addsell');
var formSearchSell = document.querySelector('.form--search__sell');
var formEditSell = document.querySelector('.form--el__editsell');
var formPrintSell = document.querySelector('.form--sell__print');

// Product form
var formAddProduct = document.querySelector('.form--el__addproduct');
var formAllProduct = document.querySelector('.form_el-allProduct');
var formEditProduct = document.querySelector('.form--el__editProduct');
var formSearchProduct = document.querySelector('.form__search--product');
var formPrintProduct = document.querySelector('.form--product__print');

// product typs form
var formAddTypeOf = document.querySelector('.form--el__addtypeOf');
var formSearchTypeOf = document.querySelector('.form--search__typeOf');
var formEditTypeOf = document.querySelector('.form--el__edittypeOf');
...
if (loginForm) {
  var btnLogin = document.querySelector('.login_btn');
  btnLogin.addEventListener('click', function (e) {
    e.preventDefault();
    var email = document.querySelector('.input_user_email').value;
...
if (formUpdateMe) {
  var forgot_passwindow = document.querySelector('.forgot_passwindow');
  var btnupdate = document.querySelector('.updateme_btn');
  var btnforgotpasslinks = document.querySelector('.links_forgot_password');
  var btnupdatePassword = document.querySelector('.update_password_btn');
  ...
  if (btnupdatePassword) btnupdatePassword.addEventListener('click', function (e) {
    e.preventDefault();
    auth.updatePassword();
  });
}
...
if (formSearchPurchase) {
  ...
  var btnpurchaseEdit = document.querySelectorAll('.btn-edit');
  var btnpurchasePrint = document.querySelectorAll('.btn-print');
  var btnpurchaseDelete = document.querySelectorAll('.btn-delete');
  var purchaseId;

  // i) Eidt purchase Button
  btnpurchaseEdit.forEach(function (el) {
    return el.addEventListener('click', function (e) {
      e.preventDefault();
  ...
  btnpurchaseDelete.forEach(function (el) {
  ...
  btnpurchasePrint.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      purchaseId = e.target.parentElement.parentElement.dataset.purchaseid;
...
if (formEditPurchase) {
  ...
  var _btnprice = document.querySelectorAll('#price');
  var _btnquantity = document.querySelectorAll('#quantity');
  (0, _alart.autoMultiply)(_btnprice, _btnquantity);
...
if (formAddSell) {
  // for auto amout sum
  var _btnprice2 = document.querySelectorAll('#price');
  var _btnquantity2 = document.querySelectorAll('#quantity');
  (0, _alart.autoMultiply)(_btnprice2, _btnquantity2);
...
if (formSearchSell) {
  ...
  var btnsellEdit = document.querySelectorAll('.btn-edit');
  var btnsellPrint = document.querySelectorAll('.btn-print');
  var btnsellDelete = document.querySelectorAll('.btn-delete');
  var sellId;

  // i) Eidt sell Button
  btnsellEdit.forEach(function (el) {
    return el.addEventListener('click', function (e) {
      e.preventDefault();
  ...
  // ii) Delete Payment Button
  btnsellDelete.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      sellId = e.target.parentElement.parentElement.dataset.sellid;
  ...
  btnsellPrint.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      sellId = e.target.parentElement.parentElement.dataset.sellid;
      // console.log(sellId);
...
if (formEditSell) {
  // i) render Page
  sell.renderViewPage();
  var _btnprice3 = document.querySelectorAll('#price');
  var _btnquantity3 = document.querySelectorAll('#quantity');
  (0, _alart.autoMultiply)(_btnprice3, _btnquantity3);
...
//Product
if (formAddProduct) {
  var btnAdd = document.querySelector('#addproduct');
...
if (formAllProduct) {
  ...
  btnEdit.forEach(function (el) {
    return el.addEventListener('click', function (e) {
      e.preventDefault();
      productId = e.target.parentElement.parentElement.querySelector('#product').dataset.productid;
...
if (formSearchProduct) {
  ...
  var _btnSearch = document.querySelector('#searchproduct');
  if (productData) heading.textContent = "Search data about ".concat(productData.data.name, " and fullfill information below");
...
// Type Of product
if (formAddTypeOf) {
  var _btnAdd = document.querySelector('#addtypeOf');
...
if (formSearchTypeOf) {
  ...
  _btnEdit.forEach(function (el) {
    return el.addEventListener('click', function (e) {
      e.preventDefault();
      typeOfId = e.target.parentElement.parentElement.querySelector('#typeof').dataset.typeofid;
...
if (formEditTypeOf) {
  ...
  var _btnUpdate = document.querySelector('.btn-update');
  _btnUpdate.addEventListener('click', function (e) {
    e.preventDefault();
    typeOfProduct.addtypeOfProductToDB('update');
  });
}
},{"./auth":"auth.js","./product":"product.js","./purchase":"purchase.js","./sell":"sell.js","./typeOfProduct":"typeOfProduct.js","./alart":"alart.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "6062" + '/');
