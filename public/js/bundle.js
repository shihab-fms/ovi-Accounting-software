...
exports.showModal = exports.showAlert = exports.searchContent = exports.modifyDate = exports.massiveError = exports.hideAlert = void 0;
...
var massiveError = function massiveError(type, msg) {
  alert(msg);
};
exports.massiveError = massiveError;
...
var modifyDate = function modifyDate() {
  document.querySelectorAll('#date').forEach(function (el) {
    return el.textContent = new Date(el.textContent).toLocaleDateString('en-US', {
      day: '2-digit',
      month: 'short',
      year: 'numeric'
    });
...
var searchContent = function searchContent(type) {
  var input, filter, perentEl, chieldEl, a, i, txtValue;
  ...
  for (i = 0; i < chieldEl.length; i++) {
    a = type === 'BL' ? chieldEl[i].getElementsByTagName('label')[1] : chieldEl[i].getElementsByTagName('label')[2];
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') (0, _alert.showAlert)('success', 'Logged out successful');
          window.setTimeout(function () {
            location.assign('/');
          }, 1500);
          _context2.next = 12;
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', 'Your are not logged in! Please try again...');
        case 12:
        case "end":
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var btnAddBranchEmployees = document.querySelectorAll('#addEmployee');
var btnAddmoreBranchEmployees = document.querySelectorAll('#anotherEmployee');

// Functionality

var addEmployee = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var res, employees, markup;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
        ...
        case 3:
          ...
          if (res.data.status = 'success') {
            ...
            markup = "<select\n                class=\"form-select form-control m-1\" required id=\"employee\"\n              >\n                <option selected>Select employees</option>\n                ".concat(res.data.data.data.map(function (el) {
              return "<option value=".concat(el._id, ">").concat(el.name, "</option>");
            }), "\n              </select>");
...
var getLedger = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
  ...
  return function getLedger() {
    return _ref2.apply(this, arguments);
  };
}();
var saveNewPaymentOrUpdate = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(type) {
    var id, method, url, name, address, description, employeesEl, employees, i, res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          console.log(document.querySelector('#branchname').dataset.branchid);
          id = type === 'update' ? document.querySelector('#branchname').dataset.branchid : '';
          method = type === 'new' ? 'POST' : 'PATCH';
          url = type === 'new' ? 'http://127.0.0.1:3000/api/v1/branchs/newOne' : "http://127.0.0.1:3000/api/v1/branchs/update/".concat(id);
          name = document.querySelector('#branchname').value;
          address = document.querySelector('#address').value;
          description = document.querySelector('#descriptions').value;
          employeesEl = document.querySelectorAll('#employee');
          employees = [];
          for (i = 0; i < employeesEl.length; i++) {
            if (employeesEl[i].value !== 'Select employees') employees.push(employeesEl[i].value);
          }
        ...
        case 13:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type, " branch implimention successfully"));
            window.setTimeout(function () {
  ...
  return function saveNewPaymentOrUpdate(_x) {
    return _ref3.apply(this, arguments);
  };
}();
exports.saveNewPaymentOrUpdate = saveNewPaymentOrUpdate;
var branchReport = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(branchId, from, to) {
    var ledgers, pay, infoOfBranch;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return getLedger();
        case 3:
          ledgers = _context5.sent;
          pay = [];
          _context5.next = 7;
          return Promise.all(ledgers.map( /*#__PURE__*/function () {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('success', 'Viewing branch report in seconds....');
          window.setTimeout(function () {
  ...
  return function branchReport(_x2, _x3, _x4) {
    return _ref4.apply(this, arguments);
  };
}();
exports.branchReport = branchReport;
var renderBranchView = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(printbody) {
    var branchData, infoOfBranch, sumOf, resOfBranch, ledgerId, ledgers, markup;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          branchData = JSON.parse(localStorage.getItem('branchReport'));
          infoOfBranch = JSON.parse(localStorage.getItem('infoOfBranch')); // Getting Sum Of Total Branch Cost Report
          sumOf = branchData.map(function (el) {
            return el.reduce(function (acc, el) {
              return acc + el.summeryAmount;
            }, 0);
          }).reduce(function (acc, el) {
            return acc + el;
          }, 0); // Geting out Name of Branch from DB via ID from LocalStorage info
          _context7.next = 6;
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:3000/api/v1/branchs/branch/".concat(infoOfBranch.branchId)
          });
        case 6:
          resOfBranch = _context7.sent;
          // Getting Ledger Serially from DB using ID from branchData
          ledgerId = branchData.map(function (el) {
            return el[0].payments[0].ledgerName;
          });
          _context7.next = 10;
          return Promise.all(ledgerId.map( /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                while (1) switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    return (0, _axios.default)({
                      method: 'GET',
                      url: "http://127.0.0.1:3000/api/v1/ledgers/single/".concat(el)
                    });
                  case 2:
                    resOfLedgers = _context6.sent;
                    return _context6.abrupt("return", resOfLedgers.data.data.data.name);
                  case 4:
                  case "end":
        ...
        case 10:
          ledgers = _context7.sent;
          markup = "\n      <div class=\"mt-3 row align-content-center print--address\">\n        <h4 class=\"col-12 d-flex justify-content-center h6\">\n          Branch report of\n        </h4>\n      </div>\n      <div class=\"row align-content-center print--branch\">\n        <p class=\"col-12 d-flex justify-content-center h5\">".concat(resOfBranch.data.data.data.name, "</p>\n      </div>\n      <div class=\"row mt-2 align-content-center print--voucher\">\n        <div class=\"col d-flex justify-content-around \">\n          <p>\n            From:<span class=\"v--date__from\"> ").concat(infoOfBranch.from.split('T')[0], " </span>To:\n            <span class=\"v--date__to\"> ").concat(infoOfBranch.to.split('T')[0], " </span>\n          </p>\n        </div>\n      </div>\n      <table class=\"table\">\n        <thead>\n            <tr>\n              <th scope=\"col\">SL No</th>\n              <th scope=\"col\">Name</th>\n              <th scope=\"col\">Debit</th>\n              <th scope=\"col\">Credit</th>\n            </tr>\n        </thead>\n        <tbody>\n            ").concat(branchData.map(function (el, i) {
            return "\n                    <tr>\n                      <th>".concat(i + 1, "</th>\n                      <td>").concat(ledgers[i], "</td>\n                      <td>").concat(el.reduce(function (acc, el) {
              return acc + el.summeryAmount;
            }, 0), "</td>\n                      <td>").concat(el.reduce(function (acc, el) {
              return acc + el.summeryAmount;
            }, 0), "</td>\n                    </tr>\n                  ");
  ...
  return function renderBranchView(_x6) {
    return _ref6.apply(this, arguments);
  };
}();
exports.renderBranchView = renderBranchView;
var renderBranchPrint = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(printbody) {
    var branchData, infoOfBranch, sumOf, resOfBranch, ledgerId, ledgers, markup;
            ...
            var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(el) {
              ...
              return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                while (1) switch (_context8.prev = _context8.next) {
                  ...
                  case 2:
                    resOfLedgers = _context8.sent;
                    return _context8.abrupt("return", resOfLedgers.data.data.data.name);
                  case 4:
                  case "end":
  ...
  return function renderBranchPrint(_x8) {
    return _ref8.apply(this, arguments);
  };
}();
exports.renderBranchPrint = renderBranchPrint;
var editBranch = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:3000/api/v1/branchs/branch/".concat(id)
          });
        case 3:
          res = _context10.sent;
          if (res.data.status === 'success') {
            ...
            (0, _alert.showAlert)('success', 'Searching for branch');
            window.setTimeout(function () {
...
var deleteBranch = function deleteBranch(id) {
  ...
  confirmModalButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
    var res;
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:3000/api/v1/branchs/delete/".concat(id)
          });
        case 4:
          res = _context11.sent;
          (0, _alert.showAlert)('success', 'Branch deleted successfully');
          window.setTimeout(function () {
            location.reload();
          }, 1500);
          _context11.next = 14;
        ...
        case 9:
          ...
          if (_context11.t0.response.data.message === 'You do not have permission to perform this action')
            // massiveError();
            alert('Hey! Who the heal are you tring to do bod 😠🌟🌟🌟');
          (0, _alert.showAlert)('error', _context11.t0.response.data.message);
        case 14:
        case "end":
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"payment.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendSumAmount = exports.searchedPaymentToView = exports.saveNewPaymentOrUpdate = exports.renderViewPage = exports.renderPrint = exports.removePaymentLedgerElement = exports.printPayment = exports.deleteRenderViewPageEl = exports.deletePayment = exports.addPaymentLedgerEement = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var sendSumAmount = function sendSumAmount() {
  var amountEL = document.querySelector('.amount');
  var amount = [];
  var el = document.querySelectorAll('#amount').forEach(function (el) {
    return amount.push(+el.value);
  });
  amountEL.innerHTML = "Total Amount Tk.= ".concat(amount.reduce(function (acc, el) {
    return acc + el;
  }, 0), "/-");
};

//   2) Add button for inputing new Ledger payment Element
exports.sendSumAmount = sendSumAmount;
var addPaymentLedgerEement = function addPaymentLedgerEement() {
  var btnAdd = document.querySelector('#add--more__ledger');
  ...
  btnAdd.addEventListener('click', function (e) {
    ...
    (0, _axios.default)({
      ...
      var ledgers = res.data.data.data;
      var markup = "\n              <div class=\"payment--content payment--content__body\">\n                <label for=\"\" class=\"mb-0 m-3 form-label text-wrap slNo\">".concat(document.querySelectorAll('.slNo').length + 1, "</label>\n                <select\n                  style=\"width: 30%\"\n                  class=\"form-select form-control m-3\"\n                  name=\"ledgerName\"\n                  id=\"ledgerName\"\n                  required\n                >\n                  <option selected>Select a ledger name</option>\n                  ").concat(ledgers.map(function (el) {
        return "<option value=".concat(el._id, ">\n                    ").concat(el.name, "\n                  </option>");
      }), "\n                </select>\n                <input\n                  style=\"width: 32%\"\n                  type=\"text\"\n                  id=\"purpose\"\n                  class=\"form-control m-3\"\n                  required\n                  placeholder=\"put some comments\"\n                />\n                <input\n                  style=\"width: 32%\"\n                  type=\"number\"\n                  id=\"amount\"\n                  class=\"form-control m-3\"\n                  required\n                  placeholder=\"Amount\"\n                />\n              </div>\n      ");
      parentEl.insertAdjacentHTML('beforeend', markup);
    }).catch(function (err) {
      return (0, _alert.showAlert)('error', err.response.data.message);
    });
  });
};

//   3) Removeing last Payment items
exports.addPaymentLedgerEement = addPaymentLedgerEement;
var removePaymentLedgerElement = function removePaymentLedgerElement() {
  var btnRemove = document.querySelector('#remove--last__ledger');
  var paymentBodyEl = document.querySelector('.data');
...
exports.removePaymentLedgerElement = removePaymentLedgerElement;
var searchedPaymentToView = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(paymentId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:3000/api/v1/payments/single/".concat(paymentId)
          });
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            ...
            (0, _alert.showAlert)('success', 'we are going in seconds...');
            window.setTimeout(function () {
  ...
  return function searchedPaymentToView(_x) {
    return _ref.apply(this, arguments);
  };
}();

//   5) Delete Payment
exports.searchedPaymentToView = searchedPaymentToView;
var deletePayment = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(paymentId) {
    var cancelModalButton, confirmModalButton;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          (0, _alert.showModal)();
          cancelModalButton = document.getElementById('cancelModalButton');
          confirmModalButton = document.getElementById('confirmModalButton'); // for cancling
          cancelModalButton.addEventListener('click', function () {
            document.getElementById('confirmationModal').style.display = 'none';
          });

          // for confirm deleting
          confirmModalButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var res;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  return (0, _axios.default)({
                    method: 'DELETE',
                    url: "http://127.0.0.1:3000/api/v1/payments/delete/".concat(paymentId)
                  });
                case 4:
                  res = _context2.sent;
                  localStorage.clear();
                  (0, _alert.showAlert)('success', 'Payment Deleted Successfully');
  ...
  return function deletePayment(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
var printPayment = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(paymentId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
  ...
  return function printPayment(_x3) {
    return _ref4.apply(this, arguments);
  };
}();

//   7) Render View Payment Page from All Payment Page
exports.printPayment = printPayment;
var renderViewPage = function renderViewPage() {
  var viewPaymentForm = document.querySelector('.form__payment--view');
  var paymentData = JSON.parse(localStorage.getItem('paymentData'));
  var payments = paymentData.data.payment;
  var markup = "\n          <div class=\"payment--header\" data-paymentid=\"".concat(paymentData.data._id, "\">\n              <div class=\"payment--content\">\n                <label for=\"branch\" class=\"mb-0 m-3 form-label text-wrap\"\n                  >Branch*</label\n                >\n                <input type=\"texy\" id=\"branch\"  value=\"").concat(paymentData.data.branch.name, "\" readonly class=\"form-control m-3\" />\n              </div>\n              <div class=\"payment--content\">\n                <label for=\"date\" class=\"mb-0 m-3 form-label text-wrap\"\n                  >From:</label\n                >\n                <input type=\"date\" value=\"").concat(paymentData.data.date.split('T')[0], "\" id=\"date\" class=\"form-control m-3\" />\n              </div>\n            </div>\n            <div class=\"payment--body\">\n              <div class=\"payment--content payment--content__header\">\n                <label class=\"mb-0 m-3 form-label text-wrap\">SL No*</label>\n                <label class=\"mb-0 m-3 form-label text-wrap\"\n                  >Ledger Name*</label\n                >\n                <label class=\"mb-0 m-3 form-label text-wrap\">Narrations*</label>\n                <label class=\"mb-0 m-3 form-label text-wrap\">Amount*</label>\n              </div>\n              <div class=\"data\">\n                ").concat(payments.map(function (el, i) {
    return "<div class=\"payment--content payment--content__body\">\n                  <label for=\"\" class=\"mb-0 m-3 form-label text-wrap\">".concat(i + 1, "</label>\n                  <label\n                    style=\"width: 32%\"\n                    id=\"ledgerName\"\n                    class=\"form-control m-3\"\n                    data-ledgerid=\"").concat(el.ledgerName._id, "\"\n                  >\n                  ").concat(el.ledgerName.name, "\n                  </label>\n                  <input\n                    style=\"width: 32%\"\n                    type=\"text\"\n                    id=\"purpose\"\n                    class=\"form-control m-3\"\n                    required\n                    value=\"").concat(el.purpose, "\"\n                    placeholder=\"put some comments\"\n                  />\n                  <input\n                    style=\"width: 32%\"\n                    type=\"number\"\n                    id=\"amount\"\n                    value=\"").concat(el.amount, "\"\n                    class=\"form-control m-3\"\n                    required\n                    placeholder=\"Amount\"\n                  />\n                  <button class=\"m-3 btn btn-danger btn-sm\" id=\"view--payment__delete\">Delete</button>\n                </div>\n                ");
...
var deleteRenderViewPageEl = function deleteRenderViewPageEl() {
  var btndeletePreviousItem = document.querySelectorAll('#view--payment__delete');
  btndeletePreviousItem.forEach(function (el) {
...
exports.deleteRenderViewPageEl = deleteRenderViewPageEl;
var saveNewPaymentOrUpdate = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(type) {
    var btnSave;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          btnSave = document.querySelector('#add--payment__submit');
          btnSave.addEventListener('click', /*#__PURE__*/function () {
            var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
              var date, branch, ledgerName, purpose, amount, payment, url, method, id, i, summeryAmount, data, res;
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  case 0:
                    e.preventDefault();
                    ...
                    branch = type === 'new' ? document.querySelector('#branch').value : null;
                    ledgerName = document.querySelectorAll('#ledgerName');
                    purpose = document.querySelectorAll('#purpose');
                    amount = document.querySelectorAll('#amount');
                    payment = [];
                    url = type === 'new' ? 'http://127.0.0.1:3000/api/v1/payments/newOne' : type === 'update' ? 'http://127.0.0.1:3000/api/v1/payments/updatePayment' : null;
                    method = type === 'new' ? 'POST' : 'PATCH'; // console.log(method);
                    id = type === 'update' ? document.querySelector('.payment--header').dataset.paymentid : null; //// Get a subtotal
                    sendSumAmount();

                    // Menipulating ledgerName

                    for (i = 0; i < ledgerName.length; i++) {
                      payment.push({
                        // if(ledgerName.nodeName==="LABEL")
                        ledgerName: ledgerName[i].nodeName === 'LABEL' ? ledgerName[i].dataset.ledgerid : ledgerName[i].value,
                        purpose: purpose[i].value,
                        amount: amount[i].value * 1
                      });
                    }
                    summeryAmount = payment.reduce(function (acc, el) {
                  ...
                  case 17:
                    res = _context5.sent;
                    if (res.data.status === 'success') {
                      (0, _alert.showAlert)('success', "Payment ".concat(type === 'new' ? 'Saved' : 'updated', " successfully"));
                      window.setTimeout(function () {
  ...
  return function saveNewPaymentOrUpdate(_x4) {
    return _ref5.apply(this, arguments);
  };
}();
...
//  10) Print Payment
exports.saveNewPaymentOrUpdate = saveNewPaymentOrUpdate;
var renderPrint = function renderPrint(printPaymentFrom) {
  var paymentData = JSON.parse(localStorage.getItem('paymentData'));
  var markup = "\n    <div class=\"row align-content-center print--title\">\n      <div class=\"col-12 d-flex justify-content-center\">\n          <h2 class=\"h2 heading mt-4\">Alif Enterprise</h2>\n        </div>\n      </div>\n      <div class=\"row align-content-center print--address\">\n        <h4 class=\"sub-heading col-12 d-flex justify-content-center h6\">\n          Modina Market(Third and Forth Floor), Muradpur, Chittagong.\n        </h4>\n      </div>\n      <div class=\"row align-content-center print--branch\">\n        <p class=\"col-12 d-flex justify-content-center h4\">".concat(paymentData.data.branch.name, "</p>\n        <p class=\"col-12 d-flex justify-content-center h6\">").concat(paymentData.data.branch.address === undefined ? '' : paymentData.data.branch.address, "</p>\n      </div>\n      <div class=\"row align-content-center print--header\">\n        <h3 class=\"col-12 d-flex justify-content-center h3 print--type\">\n          Payment Slip\n        </h3>\n      </div>\n      <div class=\"row mt-2 align-content-center print--voucher\">\n        <div class=\"col-8 align-content-center\">\n          <p>Voucher No: ").concat(paymentData.data._id, "</p>\n        </div>\n        <div class=\"col align-content-center\">\n          <p>Date:<span class=\"v--date\">").concat(paymentData.data.date.split('T')[0], "</span></p>\n        </div>\n      </div>\n      <div class=\"row\">\n        <table class=\"table\">\n          <thead>\n            <tr>\n              <th scope=\"col\">SL No</th>\n              <th scope=\"col\">Ledger</th>\n              <th scope=\"col\">Narrations</th>\n              <th scope=\"col\">Debit</th>\n              <th scope=\"col\">Credit</th>\n            </tr>\n          </thead>\n          <tbody>\n            ").concat(paymentData.data.payment.map(function (el, i) {
    return "\n                <tr>\n                  <th scope=\"row\">".concat(i + 1, "</th>\n                  <td>").concat(el.ledgerName.name, "</td>\n                  <td>").concat(el.purpose, "</td>\n                  <td>").concat(el.amount, "</td>\n                  <td>00.00</td>\n                </tr>\n              ");
  }), "\n            <tr>\n              <th scope=\"row\"></th>\n              <td></td>\n              <th>Total=</th>\n              <th>").concat(paymentData.data.summeryAmount.toFixed(2), "</th>\n              <th>").concat(paymentData.data.summeryAmount.toFixed(2), "</th>\n            </tr>\n          </tbody>\n        </table>\n      </div>\n      <div class=\"row mt-5 align-content-center print--footer\">\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label class=\"h6\"> &nbsp;&nbsp;&nbsp;&nbsp;Prepared By&nbsp;&nbsp;&nbsp;&nbsp; </label>\n        </div>\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label class=\"h6\">&nbsp;&nbsp;&nbsp;&nbsp;Checked By&nbsp;&nbsp;&nbsp;&nbsp;</label>\n        </div>\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label class=\"h6\">&nbsp;&nbsp;&nbsp;&nbsp;Approved By&nbsp;&nbsp;&nbsp;&nbsp;</label>\n        </div>\n      </div>\n    </div>\n  ");
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"ledger.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.searchLedger = exports.renderSearchLedger = exports.renderEditPage = exports.printLedger = exports.editLedger = exports.deleteLedger = exports.createNewOneOrUpdate = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var getAllFromApi = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:3000/api/v1/".concat(apiKey, "s/all")
          });
        case 3:
          res = _context.sent;
          if (!(res.data.status === 'success')) {
  ...
  return function getAllFromApi(_x) {
    return _ref.apply(this, arguments);
  };
}();
var createNewOneOrUpdate = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(types) {
    var name, email, phone, type, description, address, id, method, url, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          name = document.querySelector('#ledgername').value;
          email = document.querySelector('#email').value;
          phone = document.querySelector('#phone').value;
          type = [document.querySelector('#type').value];
          description = document.querySelector('#descriptions').value;
          address = document.querySelector('#address').value;
          id = types === 'update' ? document.querySelector('.ledgerId').dataset.ledgerid : '';
          method = types === 'new' ? 'POST' : 'PATCH';
          url = types === 'new' ? 'http://127.0.0.1:3000/api/v1/ledgers/newOne' : "http://127.0.0.1:3000/api/v1/ledgers/update/".concat(id);
        ...
        case 13:
          ...
          if (res.data.status === 'success') {
            window.setTimeout(function () {
              (0, _alert.showAlert)('success', "".concat(types, " Party added successfully..."));
  ...
  return function createNewOneOrUpdate(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

//'/single/:id
exports.createNewOneOrUpdate = createNewOneOrUpdate;
var editLedger = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 3;
          return (0, _axios.default)({
            url: "http://127.0.0.1:3000/api/v1/ledgers/single/".concat(id),
            method: 'GET'
          });
        case 3:
          res = _context3.sent;
        ...
        case 6:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alert.showAlert)('success', "Going for edit Party");
            window.setTimeout(function () {
  ...
  return function editLedger(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
exports.editLedger = editLedger;
var renderEditPage = function renderEditPage(editLedgerForm) {
  var ledgerData = JSON.parse(localStorage.getItem('ledgerData'));
  var typeOfData = JSON.parse(localStorage.getItem('typeOfData'));
  localStorage.clear();
  var markup = "\n         <form\n            action=\"\"\n            class=\"form form__edit--ledger form-group m-3 px-3 mt-5 b-2 border border-danger\"\n          >\n            <h2 class=\"text-center form-text\">\n              Updating Party*: you must need a Name*, Type* of Party and others info.\n            </h2>\n            <div class=\"ledger--info\">\n              <label for=\"ledgername\" data-ledgerid=\"".concat(ledgerData.data._id, "\" class=\"mb-0 m-1 form-label ledgerId text-wrap\"\n                >Name of Party*:</label\n              >\n              <input type=\"text\" value=\"").concat(ledgerData.data.name, "\" required id=\"ledgername\" class=\"form-control m-1\" />\n              <label for=\"email\" class=\"mb-0 m-1 form-label text-wrap\"\n                >Email of Party:</label\n              >\n              <input type=\"text\" value=\"").concat(ledgerData.data.email, "\" id=\"email\" class=\"form-control m-1\" />\n              <label for=\"phone\" class=\"mb-0 m-1 form-label text-wrap\"\n                >Contact:</label\n              >\n              <input type=\"tel\" required value=\"").concat(ledgerData.data.phone, "\" id=\"phone\" class=\"form-control m-1\" />\n              <label for=\"address\" class=\"mb-0 m-1 form-label text-wrap\"\n                >Address:</label\n              >\n              <input type=\"text\" required value=\"").concat(ledgerData.data.address, "\" id=\"address\" class=\"form-control m-1\" />\n\n              <label for=\"type\" class=\"mb-0 m-1 form-label text-wrap\"\n                >Type of Party*:</label\n              >\n              <select class=\"form-select form-control m-1\" required id=\"type\">\n                <option value=\"").concat(ledgerData.data.typeof[0]._id, "\" selected>").concat(ledgerData.data.typeof[0].slug, "</option>\n                ").concat(typeOfData.data.map(function (el) {
    return "<option value=\"".concat(el._id, "\">").concat(el.name, "</option>");
  }), "\n                \n              </select>\n\n              <label for=\"descriptions\" class=\"mb-0 m-1 form-label text-wrap\"\n                >Descriptions:</label\n              >\n              <textarea\n                class=\"form-control\"\n                id=\"descriptions\"\n                value=\"").concat(ledgerData.data.description, "\"\n                cols=\"10\"\n                rows=\"3\"\n              ></textarea>\n            </div>\n            <button class=\"m-3 btn btn-update btn-info\">Update</button>\n          </form>\n  ");
  editLedgerForm.insertAdjacentHTML('afterbegin', markup);
};
exports.renderEditPage = renderEditPage;
var searchLedger = /*#__PURE__*/function () {
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            localStorage.clear();
            localStorage.setItem('ledgerData', JSON.stringify(res.data.data));
            (0, _alert.showAlert)('success', 'Searching for party');
            window.setTimeout(function () {
  ...
  return function searchLedger(_x4) {
    return _ref4.apply(this, arguments);
  };
}();
exports.searchLedger = searchLedger;
var deleteLedger = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          // for confirm deleting
          confirmModalButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
            var res;
            return _regeneratorRuntime().wrap(function _callee5$(_context5) {
              while (1) switch (_context5.prev = _context5.next) {
                case 0:
                  ...
                  return (0, _axios.default)({
                    method: 'DELETE',
                    url: "http://127.0.0.1:3000/api/v1/ledgers/delete/".concat(id)
                  });
                case 4:
                  res = _context5.sent;
                  (0, _alert.showAlert)('success', 'Data deleted successfully');
                  window.setTimeout(function () {
                    location.assign('/allLedger');
                  });
                  _context5.next = 12;
  ...
  return function deleteLedger(_x5) {
    return _ref5.apply(this, arguments);
  };
}();
exports.deleteLedger = deleteLedger;
var renderSearchLedger = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    var ledgerData, ledger, branch, to, from, data, resPayment, resPurchase;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          ...
          (0, _alert.showAlert)('error', 'Ledger not found! Going back to provious page');
          return _context7.abrupt("return", window.setTimeout(function () {
            location.assign('/allLedger');
          }, 1500));
        case 5:
          ledger = ledgerData.data._id;
          branch = document.querySelector('#branchid').value;
        ...
        case 18:
          ...
          if (resPayment.data.status === 'success' && resPurchase.data.status === 'success') {
            data.ledger = ledgerData.data;
            localStorage.clear();
            localStorage.setItem('resPayment', JSON.stringify(resPayment.data.data));
            localStorage.setItem('resPurchase', JSON.stringify(resPurchase.data.data));
            localStorage.setItem('reqData', JSON.stringify(data));
            (0, _alert.showAlert)('success', 'Print data in seconds...');
            window.setTimeout(function () {
        ...
        case 23:
          ...
          _context7.t0 = _context7["catch"](0);
          console.log(_context7.t0);
          (0, _alert.showAlert)('error', 'somethings wrong data not find🌟🌟');
        case 27:
        case "end":
          return _context7.stop();
      }
  ...
  return function renderSearchLedger() {
    return _ref7.apply(this, arguments);
  };
}();
exports.renderSearchLedger = renderSearchLedger;
var printLedger = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(printLedgerFrom) {
    var reqData, resPayment, resPurchase, itemName, unitName, allBranch, purItem, payItem, data, branch, resOfBranch, markup;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          reqData = JSON.parse(localStorage.getItem('reqData'));
          resPayment = JSON.parse(localStorage.getItem('resPayment'));
          resPurchase = JSON.parse(localStorage.getItem('resPurchase'));
          _context8.next = 5;
          return getAllFromApi('item');
        case 5:
          itemName = _context8.sent;
          _context8.next = 8;
          return getAllFromApi('unit');
        case 8:
          unitName = _context8.sent;
          _context8.next = 11;
          return getAllFromApi('branch');
        case 11:
          allBranch = _context8.sent;
          purItem = resPurchase.map(function (el) {
            return _objectSpread(_objectSpread({}, el), {}, {
              items: el.items.map(function (cel) {
                return _objectSpread(_objectSpread({}, cel), {}, {
                  itemName: itemName.data.data.data.find(function (item) {
                    return item._id === cel.itemName;
                  }),
                  unit: unitName.data.data.data.find(function (unit) {
                    return unit._id === cel.unit;
                  })
                });
              }),
              branch: allBranch.data.data.data.find(function (branch) {
                return branch._id === el.branch;
              })
            });
          });
          payItem = resPayment.map(function (el) {
            return _objectSpread(_objectSpread({}, el), {}, {
              branch: allBranch.data.data.data.find(function (branch) {
                return branch._id === el.branch;
              })
          ...
          data = [].concat(_toConsumableArray(payItem), _toConsumableArray(purItem));
          ...
          _context8.next = 20;
          return (0, _axios.default)({
            url: "http://127.0.0.1:3000/api/v1/branchs/branch/".concat(reqData.branch.id),
            method: 'GET'
          });
        case 20:
          resOfBranch = _context8.sent;
        ...
        case 30:
          ...
          markup = "\n  <div class=\"container-fluid\">\n      <div class=\"row align-content-center print--title\">\n        <div class=\"col-12 d-flex justify-content-center\">\n          <h2 class=\"h2 mt-4\">Alif Enterprise</h2>\n        </div>\n      </div>\n      <div class=\"row align-content-center print--address\">\n        <h4 class=\"col-12 d-flex justify-content-center h6\">\n          Modina Market(Third and Forth Floor), Muradpur, Chittagong.\n        </h4>\n      </div>\n      <div class=\"row align-content-center print--branch\">\n        <p class=\"col-12 d-flex justify-content-center h5\">".concat(branch, "</p>\n        <p class=\"col-12 d-flex justify-content-center h5\">").concat(reqData.ledger.name, "</p>\n      </div>\n      <div class=\"row align-content-center print--header\">\n        <h3 class=\"col-12 d-flex justify-content-center h3 print--type\">\n          Party Payment\n        </h3>\n      </div>\n      <div class=\"row mt-2 align-content-center print--voucher\">\n        <div class=\"col d-flex justify-content-around \">\n          <p>\n            From:<span class=\"v--date__from\"> ").concat(reqData.from, " </span>To: \n            <span class=\"v--date__to\">").concat(reqData.to, " </span>\n          </p>\n        </div>\n      </div>     \n      <table class=\"table\">\n        <thead>\n            <tr>\n              <th scope=\"col\">SL No</th>\n              <th scope=\"col\">Date</th>\n              ").concat(branch === 'All Branch Data' ? '<th scope="col">Branch</th>' : ' ', "\n              <th scope=\"col\">Narrations</th>\n              <th scope=\"col\">Debit</th>\n              <th scope=\"col\">Credit</th>\n            </tr>\n          </thead>\n          <tbody>\n          ").concat(function () {
            var sNo = 1;
            return data.map(function (el) {
              return el.payments ? el.payments.map(function (cEl) {
                var currentSNo = sNo;
                sNo += 1;
                return "\n                    <tr>\n                      <th scope=\"row\">".concat(currentSNo, "</th>\n                      <td>").concat(el.date.split('T')[0], "</td>\n                      ").concat(branch === 'All Branch Data' ? "<td>".concat(el.branch.name, "</td>") : ' ', "\n                      <td>").concat(cEl.purpose, "</td> \n                      <td>").concat(cEl.amount.toFixed(2), "</td>\n                      <td>00.00</td>\n                    </tr>\n                  ");
              }) : el.items.map(function (cEl) {
                var currentSNo = sNo;
                sNo += 1;
                return "\n                    <tr>\n                      <th scope=\"row\">".concat(currentSNo, "</th>\n                      <td>").concat(el.date.split('T')[0], "</td>\n                      ").concat(branch === 'All Branch Data' ? "<td>".concat(el.branch.name, "</td>") : ' ', "\n                      <td>").concat(cEl.itemName.name, " ").concat(cEl.quantity).concat(cEl.unit.name, "</td>\n                      <td>00.00</td>\n                      <td>").concat(cEl.total.toFixed(2), "</td>\n                    </tr>\n                  ");
              });
            }).flat().join('');
          }(), "\n          <tr>\n            <th></th>\n            <th></th>").concat(branch === 'All Branch Data' ? "<th></th>" : ' ', "\n            <th>Total</th>\n            <th>").concat(data.reduce(function (acc, el) {
            return el.summeryAmount ? acc + el.summeryAmount : acc;
          }, 0).toFixed(2), "</th>\n            <th>").concat(reqData.ledger.typeof[0].slug === 'supplier' ? data.reduce(function (acc, el) {
            return el.total ? acc + el.total : acc;
          }, 0).toFixed(2) : data.reduce(function (acc, el) {
            return el.summeryAmount ? acc + el.summeryAmount : acc;
          }, 0).toFixed(2), "</th>\n          </tr>\n          </tbody>\n      </table>\n      <div class=\"row align-content-center print--title\">\n        <div class=\"col-12 d-flex justify-content-center\">\n          <p class=\"h6\">Closing balance: ").concat(reqData.ledger.typeof[0].slug === 'supplier' ? (data.reduce(function (acc, el) {
            return el.total ? acc + el.total : acc;
          }, 0) - data.reduce(function (acc, el) {
            return el.summeryAmount ? acc + el.summeryAmount : acc;
          }, 0)).toFixed(2) : '00.00', "</p>\n        </div>\n      </div>\n      <div class=\"row mt-5 align-content-center print--footer\">\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label>\n            &nbsp;&nbsp;&nbsp;&nbsp;Prepared By&nbsp;&nbsp;&nbsp;&nbsp;\n          </label>\n        </div>\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label\n            >&nbsp;&nbsp;&nbsp;&nbsp;Checked By&nbsp;&nbsp;&nbsp;&nbsp;</label\n          >\n        </div>\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label\n            >&nbsp;&nbsp;&nbsp;&nbsp;Approved By&nbsp;&nbsp;&nbsp;&nbsp;</label\n          >\n        </div>\n      </div>\n    </div>\n  ");
  ...
  return function printLedger(_x6) {
    return _ref8.apply(this, arguments);
  };
}();
exports.printLedger = printLedger;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"purchase.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setViewPageData = exports.saveOrUpdate = exports.renderViewPage = exports.renderPrint = exports.removeLastEl = exports.printPurchase = exports.deletePurchase = exports.autoMultiply = exports.addNewItemEl = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var data_DB = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(typeURL) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _axios.default)({
            url: "http://127.0.0.1:3000/api/v1/".concat(typeURL)
          });
        case 3:
          res = _context.sent;
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          throw _context.t0.response.data.message;
        case 10:
        case "end":
          return _context.stop();
      }
  ...
  return function data_DB(_x) {
    return _ref.apply(this, arguments);
  };
}();
var autoSum = function autoSum() {
  var amounts = document.querySelectorAll('#amount');
  var summeryamount = document.querySelector('.amount');
  summeryamount.textContent = ' ';
  var sum = 0;
  amounts.forEach(function (el) {
    return sum = sum + el.value * 1;
  });
  summeryamount.textContent = "Tk. ".concat(sum.toFixed(2));
};
var autoMultiply = function autoMultiply(btnquantity, btnrate) {
  btnquantity.forEach(function (el) {
    el.addEventListener('input', function () {
      var rate = this.parentElement.querySelector('#rate').value;
...
exports.autoMultiply = autoMultiply;
var addNewItemEl = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var body, items, units, i, markup, quantity, rate;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          ...
          autoSum();
          _context2.next = 5;
          return data_DB('items/all');
        case 5:
          items = _context2.sent;
          _context2.next = 8;
          return data_DB('units/all');
        case 8:
          units = _context2.sent;
          if (items.status === 'success' && items.status === 'success') {
            i = document.querySelectorAll('.sl'); // console.log(i[i.length-1].textContent);
            markup = "\n        <div class=\"purchase--content purchase--content__body\">\n          <label class=\"mb-0 m-1 mb-3 sl form-label text-wrap\" for=\"\">".concat(i[i.length - 1].textContent * 1 + 1, "</label>\n          <select\n            class=\"form-select form-control m-1 mb-3\"\n            id=\"itemName\"\n            style=\"width: 20%\"\n            name=\"ledgerName\"\n            required=\"\"\n          >\n            <option selected=\"\">Select Item</option>\n            ").concat(items.data.data.map(function (el) {
              return "<option value=\"".concat(el._id, "\">").concat(el.name, "</option>");
            }), ".join()\n            \n          </select>\n          <select\n            class=\"form-select form-control m-1 mb-3\"\n            id=\"unitName\"\n            style=\"width: 15%\"\n            name=\"ledgerName\"\n            required=\"\"\n          >\n            <option selected=\"\">Select Unit</option>\n            ").concat(units.data.data.map(function (el) {
              return "<option value=\"".concat(el._id, "\">").concat(el.name, "</option>");
  ...
  return function addNewItemEl() {
    return _ref2.apply(this, arguments);
  };
}();
exports.addNewItemEl = addNewItemEl;
var removeLastEl = function removeLastEl() {
  var body = document.querySelector('.data');
  if (body.childElementCount > 1) {
    body.lastChild.remove();
    autoSum();
  } else {
    (0, _alert.showAlert)('error', 'Already you in last entry');
  }
};
exports.removeLastEl = removeLastEl;
var saveOrUpdate = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(type) {
    var id, method, url, branch, ladgerName, date, items, itemName, unitName, narration, quantity, rate, i, data, res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          autoSum();
          id = type === 'update' ? document.querySelector('.purchase--header').dataset.purchaseid : ' ';
          method = type === 'new' ? 'POST' : 'PATCH';
          url = type === 'new' ? "http://127.0.0.1:3000/api/v1/purchases/newOne" : "http://127.0.0.1:3000/api/v1/purchases/update/".concat(id);
          branch = document.querySelector('#branch').value;
          ladgerName = document.querySelector('#ledger').value;
          date = document.querySelector('#date').value;
          items = [];
          itemName = document.querySelectorAll('#itemName');
          unitName = document.querySelectorAll('#unitName');
          narration = document.querySelectorAll('#narration');
          quantity = document.querySelectorAll('#quantity');
          rate = document.querySelectorAll('#rate'); // const amount = document.querySelectorAll('#amount');
        ...
        case 19:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type, " purchase successful"));
            window.setTimeout(function () {
  ...
  return function saveOrUpdate(_x2) {
    return _ref3.apply(this, arguments);
  };
}();
exports.saveOrUpdate = saveOrUpdate;
var setViewPageData = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(purchaseId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:3000/api/v1/purchases/single/".concat(purchaseId)
          });
        case 3:
          res = _context4.sent;
          if (res.data.status === 'success') {
  ...
  return function setViewPageData(_x3) {
    return _ref4.apply(this, arguments);
  };
}();
exports.setViewPageData = setViewPageData;
var deletePurchase = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(purchaseId) {
    var cancelModalButton, confirmModalButton;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
            ...
            return _regeneratorRuntime().wrap(function _callee5$(_context5) {
              while (1) switch (_context5.prev = _context5.next) {
                case 0:
                  ...
                  return (0, _axios.default)({
                    method: 'DELETE',
                    url: "http://127.0.0.1:3000/api/v1/purchases/delete/".concat(purchaseId)
                  });
                case 4:
                  res = _context5.sent;
                  localStorage.clear();
                  (0, _alert.showAlert)('success', 'Purchase Deleted Successfully');
                  location.reload(true);
                  _context5.next = 13;
                  break;
                case 10:
  ...
  return function deletePurchase(_x4) {
    return _ref5.apply(this, arguments);
  };
}();
exports.deletePurchase = deletePurchase;
var printPurchase = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(purchaseId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
  ...
  return function printPurchase(_x5) {
    return _ref7.apply(this, arguments);
  };
}();
exports.printPurchase = printPurchase;
var renderViewPage = function renderViewPage() {
  var viewPurchaseForm = document.querySelector('.form__purchase--view');
  var purchaseData = JSON.parse(localStorage.getItem('purchaseData'));
  var purchases = purchaseData.data.items;
  console.log(purchases);
  var markup = "\n    <div class=\"purchase--header\" data-purchaseid=\"".concat(purchaseData.data._id, "\">\n      <div class=\"purchase--content\">\n        <label class=\"mb-0 m-3 form-label text-wrap\" for=\"date\">Date:</label>\n        <input class=\"form-control m-3\" value=\"").concat(purchaseData.data.date.split('T')[0], "\" id=\"date\" type=\"date\" required=\"\" />\n      </div>\n      <div class=\"purchase--content\">\n        <label class=\"mb-0 m-3 form-label text-wrap\" for=\"branch\">Branch*</label\n        ><select class=\"form-select form-control m-3\" id=\"branch\" name=\"branch\">\n          <option value=\"").concat(purchaseData.data.branch._id, "\" selected=\"\">").concat(purchaseData.data.branch.name, "</option>\n        </select>\n      </div>\n      <div class=\"purchase--content\">\n        <label class=\"mb-0 m-3 form-label text-wrap\" for=\"ledger\">ledger*</label\n        ><select class=\"form-select form-control m-3\" id=\"ledger\" name=\"ledger\">\n          <option value=\"").concat(purchaseData.data.ladgerName._id, "\" selected=\"\">").concat(purchaseData.data.ladgerName.name, "</option>\n        </select>\n      </div>\n    </div>\n     <div class=\"purchase--body\">\n      <div class=\"purchase--content purchase--content__header\">\n        <label class=\"mb-0 m-1 form-label text-wrap\">SL No* </label\n        ><label class=\"mb-0 m-1 form-label text-wrap\">Item Name*</label\n        ><label class=\"mb-0 m-1 form-label text-wrap\">Unit*</label\n        ><label class=\"mb-0 m-1 form-label text-wrap\">Narration*</label\n        ><label class=\"mb-0 m-1 form-label text-wrap\">Quantity*</label\n        ><label class=\"mb-0 m-1 form-label text-wrap\">Rate* </label\n        ><label class=\"mb-0 m-1 form-label text-wrap\">Total*</label>\n      </div>\n    </div>\n    <div class=\"data\">\n\n    ").concat(purchases.map(function (el, i) {
    return "\n          <div class=\"purchase--content purchase--content__body\">\n            <label class=\"mb-0 m-1 mb-3 sl form-label text-wrap\" for=\"\">".concat(i + 1, "</label>\n            <select\n              class=\"form-select form-control m-1 mb-3\"\n              id=\"itemName\"\n              style=\"width: 20%\"\n              name=\"itemName\"\n              required=\"\"\n            >\n              <option value=\"").concat(el.itemName._id, "\" selected=\"\">").concat(el.itemName.name, "</option>\n            </select>\n            <select\n              class=\"form-select form-control m-1 mb-3\"\n              id=\"unitName\"\n              style=\"width: 20%\"\n              name=\"unitName\"\n              required=\"\"\n            >\n              <option value=\"").concat(el.unit._id, "\" selected=\"\">").concat(el.unit.name, "</option>\n            </select>\n            <input\n              class=\"form-control m-1 mb-3\"\n              id=\"narration\"\n              style=\"width: 28%\"\n              type=\"text\"\n              required=\"\"\n              placeholder=\"Comments\"\n              value=\"").concat(el.narration, "\"\n            /><input\n              class=\"form-control m-1 mb-3\"\n              id=\"quantity\"\n              style=\"width: 10%\"\n              type=\"number\"\n              required=\"\"\n              placeholder=\"Quantity\"\n              value=\"").concat(el.quantity, "\"\n            /><input\n              class=\"form-control m-1 mb-3\"\n              id=\"rate\"\n              style=\"width: 10%\"\n              type=\"number\"\n              required=\"\"\n              placeholder=\"Rate\"\n              value=\"").concat(el.rate, "\"\n            /><input\n              class=\"ledger__amount form-control m-1 mb-3\"\n              id=\"amount\"\n              style=\"width: 15%\"\n              type=\"number\"\n              required=\"\"\n              placeholder=\"Amount\"\n              value=\"").concat(el.total, "\"\n            />\n          </div>\n        ");
...
exports.renderViewPage = renderViewPage;
var renderPrint = function renderPrint(printPurchaseFrom) {
  var purchaseData = JSON.parse(localStorage.getItem('purchaseData'));
  // console.log(purchaseData);
  var markup = "\n    <div class=\"row align-content-center print--title\">\n      <div class=\"col-12 d-flex justify-content-center\">\n          <h2 class=\"h2 mt-4\">Alif Enterprise</h2>\n        </div>\n      </div>\n      <div class=\"row align-content-center print--address\">\n        <h4 class=\"col-12 d-flex justify-content-center h6\">\n          Modina Market(Third and Forth Floor), Muradpur, Chittagong.\n        </h4>\n      </div>\n      <div class=\"row align-content-center print--branch\">\n        <p class=\"col-12 d-flex justify-content-center h6\">".concat(purchaseData.data.branch.name, "</p>\n        <p class=\"col-12 d-flex justify-content-center h6\">").concat(purchaseData.data.branch.address === undefined ? '' : purchaseData.data.branch.address, "</p>\n      </div>\n      <div class=\"row align-content-center print--ladgerName\">\n        <p class=\"col-12 d-flex justify-content-center h4\">").concat(purchaseData.data.ladgerName.name, "</p>\n      </div>\n      <div class=\"row align-content-center print--header\">\n        <h3 class=\"col-12 d-flex justify-content-center h3 print--type\">\n          Purchase Slip\n        </h3>\n      </div>\n      <div class=\"row mt-2 align-content-center print--voucher\">\n        <div class=\"col d-flex justify-content-around\">\n          <p class=\"v--no\">Voucher No:").concat(purchaseData.data._id, "</p>\n        </div>\n        <div class=\"col d-flex justify-content-around\">\n          <p>Date:<span class=\"v--date\">").concat(purchaseData.data.date.split('T')[0], "</span></p>\n        </div>\n      </div>\n        <table class=\"table\">\n          <thead>\n            <tr>\n              <th scope=\"col\">SL No</th>\n              <th scope=\"col\">Item</th>\n              <th scope=\"col\">Narrations</th>\n              <th scope=\"col\">Unit</th>\n              <th scope=\"col\">Quantity</th>\n              <th scope=\"col\">Rate</th>\n              <th scope=\"col\">Total</th>\n            </tr>\n          </thead>\n          <tbody>\n            ").concat(purchaseData.data.items.map(function (el, i) {
    return "\n                    <tr>\n                      <th scope=\"row\">".concat(i + 1, "</th>\n                      <td>").concat(el.itemName.name, "</td>\n                      <td>").concat(el.narration, "</td>\n                      <td>").concat(el.unit.name, "</td>\n                      <td>").concat(el.quantity.toFixed(2), "</td>\n                      <td>").concat(el.rate.toFixed(2), "</td>\n                      <td>").concat(el.total.toFixed(2), "</td>\n                    </tr>\n                  ");
  }).join(' '), "\n\n              <tr>\n                <th scope=\"row\"></th>\n                <th scope=\"row\"></th>\n                <th scope=\"row\"></th>\n                <th scope=\"row\"></th>\n                <th scope=\"row\"></th>\n                <th scope=\"row\">Total</th>\n                <th scope=\"row\">").concat(purchaseData.data.summeryAmount.toFixed(2), "</th>\n              </tr>\n\n          </tbody>\n        </table>\n      <div class=\"row mt-5 align-content-center print--footer\">\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label> &nbsp;&nbsp;&nbsp;&nbsp;Prepared By&nbsp;&nbsp;&nbsp;&nbsp; </label>\n        </div>\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label>&nbsp;&nbsp;&nbsp;&nbsp;Checked By&nbsp;&nbsp;&nbsp;&nbsp;</label>\n        </div>\n        <div class=\"col-3 d-flex justify-content-start\">\n          <label>&nbsp;&nbsp;&nbsp;&nbsp;Approved By&nbsp;&nbsp;&nbsp;&nbsp;</label>\n        </div>\n      </div>\n    </div>\n  ");
  printPurchaseFrom.insertAdjacentHTML('afterbegin', markup);
};
exports.renderPrint = renderPrint;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"other.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showModalItem = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var saveNewOrUpdate = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(apiKey, type) {
    var method, url, name, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          method = type === 'new' ? 'POST' : 'PATCH';
          url = type === 'new' ? "http://127.0.0.1:3000/api/v1/".concat(apiKey, "s/newOne") : "http://127.0.0.1:3000/api/v1/".concat(apiKey, "s/update");
          name = document.getElementById("name--".concat(apiKey)).value;
          _context2.next = 6;
          return (0, _axios.default)({
            method: method,
            url: url,
        ...
        case 6:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type, " ").concat(apiKey, " seccessfully"));
            viewModal(apiKey);
          }
          _context2.next = 14;
          break;
  ...
  return function saveNewOrUpdate(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
...
var viewModal = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(nameModal) {
    var data, bodyNewEl, viewMarkup;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return getAll(nameModal);
        case 2:
          data = _context3.sent;
          bodyNewEl = document.querySelector('.modal-content');
          if (document.querySelector('.form-modal')) document.querySelector('.form-modal').remove();
          if (document.querySelectorAll('.form-modal').length <= 1) {
            viewMarkup = "\n        <div class=\"view form--table\" style=\"width: 95%;\">\n          <div class=\"row align-content-center\">\n            <div class=\"col-md d-flex justify-content-center\" >\n              <form\n                action=\"\"\n                class=\"form form-modal form-group m-3 px-3 mt-5 b-2 border border-danger\"\n              >\n                <p>View ".concat(nameModal, "</p>\n                ").concat(data.data.map(function (el) {
              return "<input type=\"text\" data-".concat(nameModal, "id=\"").concat(el._id, "\" value=\"").concat(el.name, "\" readonly placeholder=\"name\" required id=\"name--").concat(nameModal, "\" class=\"form-control m-1\" />");
            }).join(' '), "                \n              </form>\n            </div>\n          </div>\n        </div> \n    ");
...
exports.showModalItem = showModalItem;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"main.js":[function(require,module,exports) {
"use strict";

var _login = require("./login");
var _alert = require("./alert");
var branch = _interopRequireWildcard(require("./branch"));
var payment = _interopRequireWildcard(require("./payment"));
var ledger = _interopRequireWildcard(require("./ledger"));
var purchase = _interopRequireWildcard(require("./purchase"));
...
var btnUnit = document.querySelector('.units-list');
var btnItem = document.querySelector('.items-list');

// branch
var addBranchForm = document.querySelector('.form--el__addbranch');
var searchbranchForm = document.querySelector('.form__branch--search');
var allbranchForm = document.querySelector('.form_el-allBranch');
var editBranchForm = document.querySelector('.form--el__editbranch');
var viewBranchReport = document.querySelector('.form--branch__view');
var printBranchReport = document.querySelector('.form--branchReport__print');
// payment
var addPaymentForm = document.querySelector('.form__payment--add');
var searchPaymentFrom = document.querySelector('.form--search__payment');
var viewPaymentForm = document.querySelector('.form__payment--view');
var printPaymentForm = document.querySelector('.form--payment__print');

// Purchase

var addPurchseForm = document.querySelector('.form--el__addPurchase');
var allPurchseForm = document.querySelector('.form--search__purchase');
var viewPurchseForm = document.querySelector('.form__purchase--view');
var printPurchseForm = document.querySelector('.form--purchase__print');

//ledger
var addLedgerForm = document.querySelector('.form--el__addledger');
var allLedgerForm = document.querySelector('.form_el-allpayment');
var editLedgerForm = document.querySelector('.form--el__editledger');
var searchLedgerForm = document.querySelector('.form--el__search');
var printLedgerFrom = document.querySelector('.form--ledger__print');
...
// Dropdown manu
if (document.querySelector('.icon--res')) document.querySelector('.icon--res').addEventListener('click', function (e) {
  e.preventDefault();
...
///////////////////////////
if (btnUnit) btnUnit.addEventListener('click', function (e) {
  e.preventDefault();
  other.showModalItem('unit');
});
if (btnItem) btnItem.addEventListener('click', function (e) {
  e.preventDefault();
...
if (viewBranchReport) {
  ...
  var btnBranchReportPrint = document.querySelector('.btn-print--branchReport');
  // if (btnBranchReportPrint)
  btnBranchReportPrint.addEventListener('click', function (e) {
    e.preventDefault();
    console.log(e);
    (0, _alert.showAlert)('success', 'Printing report in seconds...');
    window.setTimeout(function () {
...
if (editBranchForm) {
  ...
  var btn_remove = document.querySelectorAll('.btn-remove-employee');
  var btn_add = document.querySelector('.btn-add-employees');
  btn_add.addEventListener('click', function (e) {
    e.preventDefault();
    branch.addEmployee();
  });
  if (btn_remove) btn_remove.forEach(function (el) {
    return el.addEventListener('click', function (e) {
      e.preventDefault();
      e.target.parentElement.remove();
    });
...
if (addBranchForm) {
  ...
  var btn_add_employee = document.querySelectorAll('.btn-add-employees');
  btn_add_employee.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      branch.addEmployee();
    });
...
if (searchPaymentFrom) {
  // Search on page
  var _search = document.querySelector('.myInput');
  _search.addEventListener('input', _alert.searchContent);
  (0, _alert.modifyDate)();
  var btnPaymentEdit = document.querySelectorAll('.btn-edit');
  var btnPaymentPrint = document.querySelectorAll('.btn-print');
  var btnPaymentDelete = document.querySelectorAll('.btn-delete');
  var paymentId;

  // i) Eidt Payment Button
  btnPaymentEdit.forEach(function (el) {
    return el.addEventListener('click', function (e) {
      e.preventDefault();
  ...
  btnPaymentDelete.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      paymentId = e.target.parentElement.parentElement.dataset.paymentid;
  ...
  btnPaymentPrint.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      paymentId = e.target.parentElement.parentElement.dataset.paymentid;
...
if (addPurchseForm) {
  ...
  var btnAddItem = document.querySelector('#add--more__item');
  var btnRemoveItem = document.querySelector('#remove--last__item');
  var btnsave = document.querySelector('#add--purchase__submit');
...
if (allPurchseForm) {
  // Search on page
  var _search2 = document.querySelector('.myInput');
  _search2.addEventListener('input', _alert.searchContent);
  (0, _alert.modifyDate)();
  var _btnEdit = document.querySelectorAll('.btn-edit');
  var btnPrint = document.querySelectorAll('.btn-print');
  var _btnDelete = document.querySelectorAll('.btn-delete');
  var purchaseId;

  // i) Eidt purchase Button
  _btnEdit.forEach(function (el) {
    return el.addEventListener('click', function (e) {
      e.preventDefault();
  ...
  _btnDelete.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      purchaseId = e.target.parentElement.parentElement.dataset.purchaseid;
...
if (viewPurchseForm) {
  ...
  var _quantity = document.querySelectorAll('#quantity');
  var _rate = document.querySelectorAll('#rate');
  var _btnAddItem = document.querySelector('#add--more__item');
  var _btnRemoveItem = document.querySelector('#remove--last__item');
  var _btnsave = document.querySelector('#add--purchase__submit');
  purchase.autoMultiply(_quantity, _rate);
  _btnAddItem.addEventListener('click', function (e) {
    e.preventDefault();
    purchase.addNewItemEl();
  });
  _btnRemoveItem.addEventListener('click', function (e) {
    e.preventDefault();
    purchase.removeLastEl();
  });
  _btnsave.addEventListener('click', function (e) {
    e.preventDefault();
...
if (addLedgerForm) {
  var btnaddLedger = document.querySelector('#addledger');
...
if (allLedgerForm) {
  // Search on page
  var _search3 = document.querySelector('.myInput');
  _search3.addEventListener('input', function () {
    (0, _alert.searchContent)('BL');
  });
  var _btnEdit2 = document.querySelectorAll('.btn-edit');
  var btnSearch = document.querySelectorAll('.btn-search');
  var _btnDelete2 = document.querySelectorAll('.btn-delete');
  var ledgerId;
  // 1) Rendering edit button page
  _btnEdit2.forEach(function (el) {
    return el.addEventListener('click', function (e) {
      e.preventDefault();
      ledgerId = e.target.parentElement.parentElement.querySelector('#ledger').dataset.ledgerid;
  ...
  _btnDelete2.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      ledgerId = e.target.parentElement.parentElement.querySelector('#ledger').dataset.ledgerid;
...
if (searchLedgerForm) {
  var ledgerData = JSON.parse(localStorage.getItem('ledgerData'));
  var heading = document.querySelector('#headertext');
  var _btnSearch = document.querySelector('#searchledger');
  if (ledgerData) {
    heading.textContent = ' ';
    var markup = "<h2 class=\"text-center form-text\" id=\"headertext\">Search data about <span style=\"color:red\">".concat(ledgerData.data.name, " </span> and fullfill information below</h2>");
    document.querySelector('.form.form__search--ledger').insertAdjacentHTML('afterbegin', markup);
  }
  _btnSearch.addEventListener('click', function (e) {
    e.preventDefault();
...
},{"./login":"login.js","./alert":"alert.js","./branch":"branch.js","./payment":"payment.js","./ledger":"ledger.js","./purchase":"purchase.js","./other":"other.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1424" + '/');
